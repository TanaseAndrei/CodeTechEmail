package com.ucv.codetechemail.configuration;
...
public class SwaggerConfiguration {
    ...
    private static final String SWAGGER_TITLE = "CodeTechEmail API Swagger documentation";
    ...
    public Docket apiDocumentation() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.ucv.codetechemail.controller"))
